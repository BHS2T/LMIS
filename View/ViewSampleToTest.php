...
//             include '../Model/SampleToTest.php';
            //  include '../Controller/AddSttController.php';

            $sample  = new SampleToTestController();
            $mydata = $sample->viewSampleToTest();
            if($mydata){
//            print_r($mydata);
            echo '<div class = "viewTable">';
            echo '<div class = "tth"><strong>View Sample To Test</strong></div>';
            echo ' <table><tr>
                <th>Customer Id</th>
...
echo 'NO SAMPLE TO TEST RESULT FOUND';
}
        ?>
    </body>
</html>