...
<html>
    ...
    <div class = "header">
        ...
        <form  class="searchForm" method ="post" action = "searchTask.php">
            <input class = "searchBox" placeholder="Search(LDN)" type="text" name ="searchText" id="dept" size="30" maxlength="25">                                     
...
//$URL = $_GET['url'];
    ...
    $task = $myTask->searchTask($userid,$ldn);
if($_POST['searchText']){
    

    echo '<div class = "viewTable">';
    echo '<div class = "allViewContainer"><div id ="searchTitle"  class = "tth"><strong>My Task</strong></div></div>';
